...
void* make_C12(void* arg)
{
    addMatrix(c, 0, N/2, M3, 0, 0, M5, 0, 0);
}

void* make_C21(void* arg)
{
    addMatrix(c, N/2, 0, M2, 0, 0, M4, 0, 0);
}

void* make_C22(void* arg)
{
...
void* make_M2(void* arg)
{
    ...
    pthread_create(&tid, NULL, make_C21, NULL);
    pthread_barrier_wait(&barrier_C22);
    pthread_join(tid, NULL);
}

void* make_M3(void* arg)
{
    ...
    pthread_create(&tid, NULL, make_C12, NULL);
    pthread_barrier_wait(&barrier_C22);
    pthread_join(tid, NULL);
}

void* make_M4(void* arg)
{
...
*/
    ...
    pthread_create(tid, NULL, make_M1, NULL);
    pthread_create(tid + 1, NULL, make_M2, NULL);
    pthread_create(tid + 2, NULL, make_M3, NULL);
    pthread_create(tid + 3, NULL, make_M4, NULL);
    pthread_create(tid + 4, NULL, make_M5, NULL);
    pthread_create(tid + 5, NULL, make_M6, NULL);
    pthread_create(tid + 6, NULL, make_M7, NULL);
