...
public class Homework {
    ...
    public static void main(String[] args) {
        if (args.length < 4) {
            System.out.println(
                    "Usage: java Homework <galaxyInfoPath> <numberOfHashes>"
                     + "<numberOfHeadQuarters> <numberOfSpaceExplorers>");
            System.exit(1);
        }
        ...
        for (int i = 0; i < numberOfHeadQuarters; ++i) {
            headQuarters[i] = new HeadQuarter(
                    args[0],
                    numberOfSpaceExplorers,
                    hashesSolved,
                    channel
            );
        ...
        try {
            ...
            for (SpaceExplorer explorer : spaceExplorers) {
                explorer.join();
            }
